 ...
 * TILE_TYPE entries.
 */
function generateMaze(width, height, doorChance, itemChance) {
  ...
  for (let x=0; x < height; x += 1) {
    for (let y=0; y < width; y += 1) {
      ...
      let wall_up = x > 0 ? maze[x-1][y] === TILE_TYPE.WALL : true;
      let wall_down = x < height-1 ? maze[x+1][y] === TILE_TYPE.WALL : true;
      let wall_left = y > 0 ? maze[x][y-1] === TILE_TYPE.WALL : true;
      let wall_right = y < width-1 ? maze[x][y+1] === TILE_TYPE.WALL : true;
