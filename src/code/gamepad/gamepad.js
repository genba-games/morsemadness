...
class Gamepad {
     ...
     * @param {Array<Phaser.Keyboard|Phaser.Gamepad>} key_container List of 
     * buttons/keys to check.
     * @param {Function} checkFunc Function that checks if the key/button is 
     * being pressed.
     */
    _keyPressed(key, key_container, checkFunc) {
        if (!key_container) return false;
