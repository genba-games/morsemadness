...
module.exports = __webpack_require__(/*! /home/berith/programming/gamedev/ggj/src/main.js */332);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    key: 'init',
    value: function init() {
      this.stage.backgroundColor = '#00aacc';
...
var _generateMaze = __webpack_require__(/*! generate-maze */ 342);

var _generateMaze2 = _interopRequireDefault(_generateMaze);

var _dweller = __webpack_require__(/*! ../sprites/dweller */ 343);

var _dweller2 = _interopRequireDefault(_dweller);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function create() {
      ...
      this.game.add.existing(new _dweller2.default({
        game: this.game,
        x: 35,
        y: 35,
        asset: 'dweller'
...
var _class = function (_Phaser$Sprite) {
    ...
    function _class(_ref) {
        ...
        _this.upKey = game.input.keyboard.addKey(_phaser2.default.Keyboard.UP);
        _this.downKey = game.input.keyboard.addKey(_phaser2.default.Keyboard.DOWN);
        _this.leftKey = game.input.keyboard.addKey(_phaser2.default.Keyboard.LEFT);
        _this.rightKey = game.input.keyboard.addKey(_phaser2.default.Keyboard.RIGHT);
        return _this;
    }
